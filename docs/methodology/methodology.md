...
**Version:** 0.1 (draft)
**Date:** April 2026
**Classification:** Restricted — for review by senior engineers and technical assurance
...
| Next review | On completion of week-5 independent expert evaluation |
...
Standards: BS EN 16247-1 (general energy audits), BS EN 16247-3 (industrial sites), CIBSE TM54.
...
Standards: GHG Protocol Corporate Standard and Scope 2 Guidance, DEFRA GHG Conversion Factors and Methodology Paper, UK ETS Order, CCL rates schedule.
...
The simulator supports four dispatch policies: merit-order (cost-minimal at short-run marginal cost), carbon-minimal (lowest emissions per kilowatt-hour delivered), Pareto-weighted (configurable cost / carbon trade-off) and regulatory-constrained (subject to ETS allowance, CCA cap or planning use-class limits). Equipment ramp rates, minimum runtimes and minimum downtimes are respected. An energy balance check is enforced at module exit and the routine raises an exception where the closure error exceeds 0.5%.

Standards: CIBSE AM17 (heat pumps in buildings, adapted for industrial), CIBSE TM54, IChemE process integration good practice, NESO Future Energy Scenarios (grid intensity).
...
Standards: BS EN 14825 (seasonal performance), BS EN 378 (refrigerating systems, all parts), F-Gas Regulation 517/2014 (UK retained), CoolProp documentation citing the underlying equations of state.
...
Standards: HM Treasury Green Book (appraisal methodology), BS EN 16247-1 §6 (techno-economic appraisal), IEA Cost & Performance Database.
...
Standards: Saltelli et al., *Global Sensitivity Analysis: The Primer*. BS EN 16247-3 §6.4 (uncertainty in industrial energy audits). HM Treasury Green Book §5.
...
Standards: Kemp, *Pinch Analysis and Process Integration*, 2nd ed. Linnhoff March, *User Guide on Process Integration*. Smith, *Chemical Process Design and Integration*. IChemE *Process Integration Best Practice Guides*.
...
Standards: BS EN 378 (parts 1–4), DSEAR Regulations 2002, ATEX Directive 2014/34/EU, F-Gas Regulation (UK retained), Pressure Equipment (Safety) Regulations 2016, PSSR 2000, CDM Regulations 2015.
...
Standards: Engineering Recommendation G99, Engineering Recommendation G5/5, BS EN 50160, BS 7671, IEEE 519, DNO Long Term Development Statements (latest editions).
...
Standards: BS EN 60300 (dependability management), OREDA (Offshore Reliability Data Handbook), Lees' *Loss Prevention in Process Industries*, IEC 61078 (reliability block diagrams).
...
*End of document IDPA-MET-001 v0.1.*
